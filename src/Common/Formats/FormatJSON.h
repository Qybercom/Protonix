	...
	namespace Formats {
		class FormatJSON : public IValueFormat {
			private:
				...
				static Value _parseValue (const String &s, int &pos, const bool root = false);
				static Value _parseObject (const String &s, int &pos);
				static Value _parseArray (const String &s, int &pos);
				static Value _parseString (const String &s, int &pos);
				static Value _parseNumber (const String &s, int &pos);
